...
| OPENAI_MODEL        | The name of the OpenAI model to be used                                     | Default: the first model in the list returned by the endpoint                                                                                                                        |
| OPENAI_EMBED_MODEL        | The name of the OpenAI embedding model to be used                                     | Default: `text-embedding-3-small`                                                                                                                        |
